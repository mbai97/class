...
while(isset($_REQUEST[$paramIndex]))
{
    ...
    {
        $code .= file_get_contents("./templates/jscript_".$version."/jsglobal.".$ftype."js");
        $code .= file_get_contents("./templates/jscript_".$version."/icons.".$ftype."js");
    }
    else if(strtolower($_REQUEST[$paramIndex])=="jsbox.min.js")
    {
        $code .= file_get_contents("./templates/jscript_".$version."/jsbox.".$ftype."js");
        $code .= file_get_contents("./templates/jscript_".$version."/jsboxv2.".$ftype."js");
    }
    else if(strtolower($_REQUEST[$paramIndex])=="jstrack.min.js")
        $code .= file_get_contents("./templates/jscript_".$version."/jstrack.".$ftype."js");
