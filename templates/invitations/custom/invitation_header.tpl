...
<div style="width:25px;position:absolute;left:272px;top:5px;cursor:pointer;background:red;" onclick="lz_tracking_close_request();lz_tracking_action_result('chat_request',false,true);return false;">&nbsp;</div>