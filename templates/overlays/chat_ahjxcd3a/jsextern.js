...
OverlayChatWidgetV2.CaptureScreen = function(_delayed,_find){

    document.getElementById('lz_overlay_chat').style.display='none';

    if(!_delayed)
    {
        setTimeout('OverlayChatWidgetV2.CaptureScreen(true,'+_find+');',200);
        return
    }
    ...
    reader.onloadend = function() {
        ...
        params += '&find=' + lz_global_base64_url_encode(_find);
