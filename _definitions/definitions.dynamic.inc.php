...
define("TEMPLATE_SCRIPT_TRACK",PATH_TEMPLATES . "jscript_".$version."/jstrack.tpl");
define("TEMPLATE_SCRIPT_CONNECTOR",PATH_TEMPLATES . "jscript_".$version."/jsconnector.tpl");
define("TEMPLATE_SCRIPT_GROUPS",PATH_TEMPLATES . "jscript_".$version."/jsgroups.tpl");
define("TEMPLATE_SCRIPT_GLOBAL",PATH_TEMPLATES . "jscript_".$version."/jsglobal.js");
