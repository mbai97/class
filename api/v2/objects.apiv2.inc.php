...
class ApiV2
{
    ...
    static function GetObjectDefinitions($_operatorA,$_chatA,$_ticketA,$_voucherA,$_ticketMessageA,$_ticketEditorA,$_kbEntry)
    {
        ...
        $objects["ChatTranscript"]["Fields"] = ApiV2::GetObjectFields("Chat");
        ...
        $objects["ChatTranscript"]["Functions"]["List"]["OutputObject"] = array("Chats"=>array(array("Chat"=>$_chatOut)));
